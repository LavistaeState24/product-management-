...
export const createRodProductManufacturingValidator = [
  body('rodStockId')
    .notEmpty()
    .withMessage('Rod stock id is required.')
    .isMongoId()
    .withMessage('Rod stock id must be a valid identifier.'),
  body('quantityUsed')
    .notEmpty()
...
export const listRodProductManufacturingValidator = [
  query('page')
    .optional()
    .isInt({ min: 1 })
...
export const getRodProductManufacturingValidator = [
  param('id').isMongoId().withMessage('Manufacturing batch id must be a valid identifier.'),
];

export const listRodProductStockValidator = [...listRodProductManufacturingValidator];

export const searchRodProductStockValidator = [
  query('page')
    .optional()
    .isInt({ min: 1 })
    .withMessage('Page must be a positive integer.')
...
export const getRodProductStockValidator = [
  param('id').isMongoId().withMessage('Rod product stock id must be a valid identifier.'),
];
