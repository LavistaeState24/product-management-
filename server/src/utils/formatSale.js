...
export function formatSale(sale) {
  ...
  return {
    ...
    referenceDate: sale.referenceDate || null,
    buyerOrderNumber: sale.buyerOrderNumber || '',
    buyerOrderDate: sale.buyerOrderDate || null,
    ...
    freightCharges: sale.freightCharges ?? invoiceAmounts.freightCharges,
    roundOff: sale.roundOff ?? invoiceAmounts.roundOff,
